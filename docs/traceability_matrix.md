...
|---|---|---|---|---|---|
| Singapore weather ingestion / QC | `docs/singapore_timeseries_input_contract.md`; `data/schemas/singapore_weather_v1.toml` | `src/weather.rs` | source-level unit tests plus successful Rust execution-evidence run #11 at commit `a1cf0f79c492232001d189d14a7be5d621025ff9` | canonical measured Singapore time series not yet acquired; manifest/licence/QC gates remain open | Foundation parser/QC only; strict schema-v1 timestamps normalize to absolute UTC, interval/gap and non-adjacent duplicate diagnostics exist, and optional humidity/pressure fields are supported; provider flags, typed manifest/site linkage and closure diagnostics remain incomplete |
