...
**Provenance:** Cooper (1969), widely reproduced by Duffie & Beckman and documented by pvlib/PVPMC.  
...
- Sandia PV Performance Modeling Collaborative, *Basic Solar Position Models*.
- Final bibliography entries should include the original/standard solar-engineering references used by the validated model.
